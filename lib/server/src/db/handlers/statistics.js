      ...
      stats: [
        {
          ...
          data: mostActiveSubmitters,
        },
        {
          label: 'Total suggestions submitted',
          data: totNumSuggestions,
        },
        {
          label: 'Average sumitted suggestion per month a year',
          data: avgSuggestionsDuringPeriod.toFixed(),
        },
        {
          label: 'Average votes per month a year back',
          data: avgVotesDuringPeriod.toFixed(),
        },
      ],
    };
}
